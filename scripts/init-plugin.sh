...
echo "GitHub repo social preview: edit assets/github-social-template.svg, export a 1280 x 640 PNG, then upload it at GitHub Settings -> General -> Social preview."
